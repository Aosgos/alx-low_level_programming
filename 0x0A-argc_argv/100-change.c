...
/**
 * main - function that prints minimum numb of coins
 * @argc: Argument Count
...
/**
 * calculate_nickels - calculate changes to make for 5 cent
 * @cents: Amount of money
 * Return: Amount left in cents.
 */
...
/**
 * calculate_couples - calculate changes to make for 2
 * @cents: Amount of money.
 * Return: Amount left in cents.
 */
